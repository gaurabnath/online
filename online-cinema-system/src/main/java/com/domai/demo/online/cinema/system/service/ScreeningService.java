...
import com.domai.demo.online.cinema.system.data.repository.*;
...
public class ScreeningService {
    ...
    public Set<Movie> getMoviesByDate(Date date) {
        List<Screening> screenings = this.screeningRepository.findByScreeningDate(new java.sql.Date(date.getTime()));
